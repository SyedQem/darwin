    ...
    <div className="container-vspr py-12 md:py-20">
      ...
      >
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.8fr)]">
          ...
          <div className="media-frame min-h-[260px] rounded-[26px] sm:min-h-[320px]">
            <Image
            ...
            <div className="media-overlay-lg">
              <p className="section-label">Highlighted listing</p>
              <p className="mt-2 text-2xl font-semibold tracking-tight">{heroListing.title}</p>
              <p className="text-secondary mt-1 text-sm">
                ${heroListing.price} • {heroListing.seller.campus}
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Search + Filters */}
      <section className="surface-panel mt-8 p-4 sm:p-5 md:p-6">
