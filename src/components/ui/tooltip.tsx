...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        'z-50 overflow-hidden rounded-xl border border-white/10 bg-[var(--bg-elevated,#131316)] px-3 py-2 text-xs text-[var(--text-primary,#f4f4f5)] shadow-[0_18px_40px_rgba(0,0,0,0.45)]',
